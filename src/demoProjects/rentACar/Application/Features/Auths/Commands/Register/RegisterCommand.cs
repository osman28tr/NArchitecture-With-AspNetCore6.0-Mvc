	...
	public class RegisterCommand:IRequest<RegisteredDto>
	{
		...
		public class RegisterCommandHandler : IRequestHandler<RegisterCommand, RegisteredDto>
		{
			...
			public async Task<RegisteredDto> Handle(RegisterCommand request, CancellationToken cancellationToken)
			{
				...
				User newUser = new() { Email = request.UserForRegisterDto.Email, PasswordHash = passwordHash, PasswordSalt = passwordSalt, FirstName = request.UserForRegisterDto.FirstName, LastName = request.UserForRegisterDto.LastName, Status = true };
